...
const TableIconButton = ({ type, onClick }) => {
    ...
    return (
        <div className="relative group inline-flex items-center justify-center">
            <button
                onClick={onClick}
                className={`p-1.5 rounded-md transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-300 ${currentConfig.style}`}
            ...
            <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover:block z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
